-- Source: https://github.com/justarandomgeek/vscode-factoriomod-debug/blob/master/mod/luaobjectinfo.lua
-- Last updated: May 8, 2020

-- Required changes:
-- * In LuaGroup comment out: 'group', 'subgroups', 'order_in_recipe'
--      These field are only allowed to be accessed depending on whether it's a group or subgroup.
--      We need to handle this manually in code. (sigh)
--
-- * In LuaItemPrototype comment out: 'place_result', 'place_as_equipment_result', 'place_as_tile_result'
--      These field contain the entity data when an item in placed, but LuaEntity's are large.
--
